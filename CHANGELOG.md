...
All notable changes to the `pi-interactive-kitty` extension (fork of `pi-interactive-shell`) will be documented in this file.

## [Unreleased]

### Changed

- Forked as `pi-interactive-kitty`, kept the bundled runtime skill name aligned as `pi-interactive-kitty`, and migrated the terminal backend from PTY emulation to kitty remote control with managed kitty tabs.
