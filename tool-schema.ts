		...
		Type.Object({
			...
			semantic: Type.Optional(Type.Object({
				...
				dynamicChoices: Type.Optional(Type.Object({
					...
					maxActions: Type.Optional(Type.Integer({ minimum: 1, maximum: 10, description: "Dynamic choice attempt budget (default 1, maximum 10)." })),
					cooldownMs: Type.Optional(Type.Integer({ minimum: 0, maximum: 86400000, description: "Minimum delay between dynamic choice attempts (default 0)." })),
